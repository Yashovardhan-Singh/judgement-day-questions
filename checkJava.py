...
def main():
    if len(sys.argv) != 3:
        print("Usage: python3 checkJava.py solution.java testcase_folder")
        sys.exit(1)
    ...
    if not solution.endswith(".java"):
        print("Error: solution must be a .java file")
        sys.exit(1)
    ...
    try:
        # Copy solution.java as Main.java
        # This allows the user's Java code to use:
        # public class Main
        java_file = os.path.join(temp_dir, "Main.java")
        shutil.copy2(solution, java_file)
